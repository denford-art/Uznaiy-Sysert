...
class HramOtIstokov extends StatefulWidget {
  @override
  _HramOtIstokovState createState() => _HramOtIstokovState();
}

class _HramOtIstokovState extends State<HramOtIstokov> {
  ...
  void _onMapCreated(YandexMapController controller) {
    ...
    controller.move(
        point: Point(latitude: 56.495807, longitude: 60.809495), zoom: 18);
  }
}
