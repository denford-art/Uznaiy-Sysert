...
class UsadbaOtIstokov extends StatefulWidget {
  @override
  _UsadbaOtIstokovState createState() => _UsadbaOtIstokovState();
}

class _UsadbaOtIstokovState extends State<UsadbaOtIstokov> {
  ...
  void _onMapCreated(YandexMapController controller) {
    ...
    controller.move(
        point: Point(latitude: 56.494942, longitude: 60.808695), zoom: 18);
  }
}
