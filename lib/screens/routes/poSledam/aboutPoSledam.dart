...
import 'package:uznay_sysert/screens/routes/poSledam/poSledam.dart';
import 'package:uznay_sysert/text_const.dart';

class AboutPoSledam extends StatefulWidget {
  @override
  _AboutPoSledamState createState() => _AboutPoSledamState();
}

class _AboutPoSledamState extends State<AboutPoSledam> {
  @override
                  ...
                  Align(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () => Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => PoSledam()),
                      ),
                    ),
                  ),
                ],
