...
class TalkovKamenPoSledam extends StatefulWidget {
  @override
  _TalkovKamenPoSledamState createState() => _TalkovKamenPoSledamState();
}

class _TalkovKamenPoSledamState extends State<TalkovKamenPoSledam> {
                ...
                Container(
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage('assets/images/talik.png'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
