...
class KluchikPoSledam extends StatefulWidget {
  @override
  _KluchikPoSledamState createState() => _KluchikPoSledamState();
}

class _KluchikPoSledamState extends State<KluchikPoSledam> {
                ...
                Container(
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage('assets/images/potop.png'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
