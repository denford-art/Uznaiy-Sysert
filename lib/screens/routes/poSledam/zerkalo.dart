...
class ZerkaloPoSledam extends StatefulWidget {
  @override
  _ZerkaloPoSledamState createState() => _ZerkaloPoSledamState();
}

class _ZerkaloPoSledamState extends State<ZerkaloPoSledam> {
                ...
                Container(
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage('assets/images/zerkalo.png'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
